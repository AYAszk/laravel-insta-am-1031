      ...
      <div class="col-4 px-0 bg-white">
        ...
        <div class="card border-0">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        {{-- If you are the owner of the post you can edit or delete --}}
                         @if (Auth::user()->id === $post->user->id)  {{--Auth::user() はユーザー情報を取得するためのヘルパー関数 --}}
                           <div class="dropdown">
                        ...
                        @else
                        {{-- If you are NOT the owner of the post, show FOLLOW/UNFOLLOW --}}
            ...
            <div class="card-body w-100">
                {{-- heart button + no. of the likes + categories--}}
                <div class="row align-items-center">
                    <div class="col-auto">
             ...
             {{-- Show all comments here --}}
               ...
               <form action="{{ route('comment.store', $post->id) }}" method="post">
                 ...
                 <div class="input-group">
                   <textarea name="comment_body{{ $post->id }}" id="comment" rows="1" class="form-control form-control-sm" placeholder="Add a comment...">{{ old('comment_body'.$post->id) }}</textarea>
